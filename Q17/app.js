...
//
console.log("unfortunately new dinner table wont arrive in time for the dinner", "so i can invite only two people for dinner.");
//using while loop ,,jb tk array ki list me 2 element nh hojate
while (friend.length > 2) {
    var removeGuest = friend.pop();
    console.log("sorry ".concat(removeGuest, "i cant invite yiu to dinner"));
}
console.log("invitation to the last two guest");
// only last 2 guest
friend.forEach(function (come) { return console.log("luckly ".concat(come, " you are still invited to dinner")); });
